...
print(f"My name is {persons[0][0]}. I am {persons[1][0]} years old. I get {persons[3][0]} TK per month. My email address is {persons[2][0]}")
print(f"My name is {persons[0][1]}. I am {persons[1][1]} years old. I get {persons[3][1]} TK per month. My email address is {persons[2][1]}")
print(f"My name is {persons[0][2]}. I am {persons[1][2]} years old. I get {persons[3][2]} TK per month. My email address is {persons[2][2]}")